...
<Steps>
  <Step title="Create an account or log in">
    If you don't have an account yet, sign up at [pulseguard.nl](https://app.pulseguard.nl)
  </Step>
  <Step title="Add your first domain">
    Click on "Add New" in the sidebar and select "Add New Domain"
  </Step>
  <Step title="Configure notifications">
    Set your notification preferences in the account settings
  </Step>
...
<Note>
  Free plans can monitor up to 3 domains with checks every 5 minutes. Upgrade to Pro or Expert plans for more domains and faster check intervals.
</Note>

## Setting Up Device Monitoring

Device monitoring requires installing a small agent on your servers or devices:
